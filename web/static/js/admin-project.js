...
async function editProject() {
    ...
    try {
        ...
        window.location.href = `/admin/projects/${id}`; // Перенаправление на страницу проекта
    } catch (error) {
...
async function deleteProject(projectId) {
    ...
    try {
        ...
        window.location.href = '/admin/projects'; // Замените на нужный вам адрес
    } catch (error) {
        // Обработка ошибки
...
async function completeProject() {
    ...
    try {
        ...
        window.location.href = "http://localhost:8080/admin/projects";
    } catch (error) {
